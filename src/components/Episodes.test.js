...
// First test to make sure compnent renders with no errors
test("Renders without errors", () => {
  render(<Episodes episodes={[]} />);
});

// Second test to see if data passed into the component render on the page
test("Rerenders with new props", () => {
  ...
  // query for the missions that are being rerendered
